...
Represents a data report from a Data Streams stream for v2 schema (crypto
...
Represents a data report from a Data Streams stream for v3 schema (crypto
...
Represents a data report from a Data Streams stream for v4 schema (RWA stream).
