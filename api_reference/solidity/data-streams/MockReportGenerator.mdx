...
```solidity
function generateReportV2() external returns (bytes signedReport)
```

### generateReportV3

```solidity
function generateReportV3() external returns (bytes signedReport)
```

### generateReportV4

```solidity
function generateReportV4() external returns (bytes signedReport)
```
