    ...
    for (const log of receipt.logs) {
        try {
            ...
            if (parsedLog?.name == `CCIPSendRequested`) {
                ...
                const evm2EvmMessage: Evm2EvmMessage = { sourceChainSelector, sender, receiver, sequenceNumber, gasLimit, strict, nonce, feeToken, feeTokenAmount, data, tokenAmounts, sourceTokenData, messageId };
